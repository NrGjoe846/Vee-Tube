  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] pt-28 pb-10 px-4 md:px-12">
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-gray-400 mb-8">Share your political voice with the world.</p>
        ...
        <div className="bg-[#141414] border border-white/10 rounded-2xl p-6 md:p-10">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                {[
                    ...
                    <button
                        ...
                        className={`flex flex-col items-center justify-center gap-2 p-4 rounded-xl border transition-all ${contentType === type.id ? 'bg-blue-600/20 border-blue-500 text-blue-400' : 'bg-[#1a1a1a] border-transparent text-gray-400 hover:bg-[#222]'}`}
                    >
                        {type.icon}
            ...
            <form className="space-y-6">
                <div>
                    ...
                    <input 
                        type="text" 
                        className="w-full bg-[#0a0a0a] border border-gray-700 rounded-lg p-4 text-white focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 transition-colors"
                ...
                <div>
                    ...
                    <textarea 
                        className="w-full bg-[#0a0a0a] border border-gray-700 rounded-lg p-4 text-white focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 transition-colors h-32 resize-none"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="border-2 border-dashed border-gray-700 rounded-xl p-8 flex flex-col items-center justify-center text-center hover:bg-[#1a1a1a] transition-colors cursor-pointer group">
                        <div className="w-12 h-12 bg-gray-800 rounded-full flex items-center justify-center mb-4 group-hover:bg-blue-600/20 group-hover:text-blue-500 transition-colors">
                            <ImageIcon size={24} />
                        </div>
                ...
                <div className="pt-4">
                    <button type="button" className="w-full bg-gradient-to-r from-blue-600 to-red-600 hover:from-blue-500 hover:to-red-500 text-white font-bold py-4 rounded-lg shadow-lg transform active:scale-[0.98] transition-all flex items-center justify-center gap-2">
