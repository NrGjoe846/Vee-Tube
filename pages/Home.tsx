  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] pb-20 overflow-x-hidden font-sans">
      ...
      <div className="mt-12 px-4 md:px-12 mb-20 relative z-10">
        <div className="bg-gradient-to-r from-blue-950/60 to-red-950/60 rounded-3xl p-12 flex flex-col items-center justify-center gap-6 border border-white/10 text-center relative overflow-hidden shadow-2xl group">
            ...
            <div className="absolute -bottom-24 -right-24 w-64 h-64 bg-red-500/20 rounded-full blur-[100px] animate-pulse" style={{ animationDelay: '1.5s' }}></div>
            ...
            <button className="bg-white text-black font-bold py-4 px-12 rounded-full hover:bg-gray-100 transition-all shadow-[0_0_30px_rgba(255,255,255,0.2)] hover:shadow-[0_0_50px_rgba(255,255,255,0.4)] relative z-10 transform hover:scale-105">
                Start Free Trial
            </button>
        </div>
      </div>
