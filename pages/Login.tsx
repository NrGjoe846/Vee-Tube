...
const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0f1014] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      {/* Glow Orbs */}
      <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-blue-600/30 rounded-full blur-[100px] animate-pulse"></div>
      <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-purple-600/30 rounded-full blur-[100px] animate-pulse" style={{ animationDelay: '1s' }}></div>
      ...
      <div className="relative glass-panel p-10 md:p-16 rounded-2xl shadow-2xl w-full max-w-[500px] border border-white/10 animate-fade-in-up">
        ...
        <p className="text-gray-400 text-sm mb-8 leading-relaxed">Enter your credentials to access your personalized streaming experience.</p>
        ...
        <div className="mt-8 text-center text-sm text-gray-400">
            New to StreamStar? <Link to="/signup" className="text-white hover:text-blue-400 font-semibold transition-colors">Sign up now</Link>
        </div>
      </div>
    </div>
  );
